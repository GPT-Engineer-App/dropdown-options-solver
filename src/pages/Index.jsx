...
import { Container, Text, VStack, Box, FormControl, FormLabel, Button, Table, Thead, Tbody, Tr, Th, Td, Collapse, useDisclosure, Modal, ModalOverlay, ModalContent, ModalHeader, ModalFooter, ModalBody, ModalCloseButton } from "@chakra-ui/react";
  ...
  return (
    <Container centerContent maxW="container.md" height="100vh" display="flex" flexDirection="column" justifyContent="center" alignItems="center">
      <VStack spacing={4}>
        ...
        <Button onClick={onToggle} mt={4}>Toggle Collapsible Section</Button>
        ...
        <Button onClick={onOpen} mt={4}>Open Modal</Button>
